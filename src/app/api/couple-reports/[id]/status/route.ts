// =====================================================
// GET /api/couple-reports/[id]/status
// =====================================================
// progress 페이지가 3초 간격으로 폴링하는 저비용 상태 조회.
// /api/reports/[id]/status(인생 애널리스트 리포트)와 동일 계약.
...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  return NextResponse.json({
    ...
    errorMessage: isStalled ? "생성이 중단된 것으로 보입니다. 다시 시도해 주세요." : toCustomerErrorMessage(report.error_message),
