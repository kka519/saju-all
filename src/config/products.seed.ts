...
export const productsSeed: ProductSeed[] = [
  ...
  },
  {
    slug: "love-saju",
    name: "연애 사주",
    description: "16종 풀 분석으로 내 연애 성향, 반복되는 패턴, 잘 맞는 사람 유형까지 깊이 있게 풀어드려요.",
    price: 5900,
    value_line: "16종 풀 분석 · 내 연애 패턴 진단",
    display_order: 50,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    name: "연애 컨설팅+사주",
    description: "운을 풀이하는 데서 멈추지 않아요. 지금 그 관계에서 어떻게 움직일지, 행동 조언까지 두리가 가장 정성껏 담아드려요.",
    price: 29900,
    value_line: "운 분석 + 행동 전략 통합",
    display_order: 80,
    is_active: true,
  },
  {
